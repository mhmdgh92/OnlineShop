...
const AppText = (props) => {
  ...
  return (
    <View style={[{ justifyContent: 'center', backgroundColor: backgroundColor ? backgroundColor : 'transparent' }, { ...props.style }]}>
      <Text numberOfLines={numberOfLines ? numberOfLines : 0} style={[{
        ...
        marginTop: heightPixel(props.marginTop ? props.marginTop : 0), marginBottom: heightPixel(props.marginBottom ? props.marginBottom : 0), textAlign: textAlign ? textAlign : 'center',
